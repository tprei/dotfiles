...
package: codex
description: PROACTIVELY use when code changes need to be committed to git with proper documentation. Analyzes staged and unstaged changes, groups them into logical commits, writes contextual commit messages, and updates CHANGELOG entries.
model: gpt-5.5
thinking: low
...
- If you need to read into code, prefer serena over full file reads.
