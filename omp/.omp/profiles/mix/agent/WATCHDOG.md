...
The implementer is a fast, small-context model (GLM-5.3) executing a plan from a stronger planner. A cheap reviewer is valuable precisely because cross-model review catches what the implementer misses. Especially watch for:
