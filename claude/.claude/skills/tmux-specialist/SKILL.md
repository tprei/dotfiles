...
description: Quick tmux reference. Use when user asks about tmux commands, keybindings, sessions, panes, windows, or configuration.
model: haiku
---
...
| `references/tmux.conf` | Your personal tmux configuration (symlinked to dotfiles) |
