...
- Treat documentation as a first-class deliverable. 35 session(s) explicitly requested docs or READMEs.
...
- Default to running or adding tests whenever behavior shifts. 27 session(s) demanded test coverage or reruns.
...
- Bundle related commands to reduce repetitive approval requests. 9 session(s) flagged approval fatigue.
...
- Example: "Before that, I made some changes, take a look: User approved Claude's plan: F..."
- Example: "No. Use pydoll to solve the captcha https://github.com/autoscrape-labs/pydoll..."
- Example: "> - Jobs tab Download button: the popup fetches /subtitles/job/{id} expecting..."
...
- Highlight built-in tools before the user prompts you. 25 session(s) reminded Codex to employ local tooling.
...
- Example: "Let's work on a bug related to bad subtitle burning. I've just ran a job (you..."
- Example: "zhongwen on translation-stuff [$!] on v27.5.1 using default/zhongwen-438308 v..."
