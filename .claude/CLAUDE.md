...
- Treat documentation as a first-class deliverable. 129 session(s) explicitly requested docs or READMEs.
...
- Keep commits scoped and narrated. 285 session(s) asked for clearer commits or change descriptions.
