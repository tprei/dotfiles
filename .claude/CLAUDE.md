...
- Treat documentation as a first-class deliverable. 159 session(s) explicitly requested docs or READMEs.
...
- Keep commits scoped and narrated. 313 session(s) asked for clearer commits or change descriptions.
