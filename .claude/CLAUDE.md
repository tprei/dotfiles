...
- Treat documentation as a first-class deliverable. 156 session(s) explicitly requested docs or READMEs.
...
- Keep commits scoped and narrated. 309 session(s) asked for clearer commits or change descriptions.
